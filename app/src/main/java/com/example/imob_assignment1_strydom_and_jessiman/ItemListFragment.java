...
import com.example.imob_assignment1_strydom_and_jessiman.databinding.FragmentItemListBinding;
import com.example.imob_assignment1_strydom_and_jessiman.databinding.ItemListContentBinding;
...
public class ItemListFragment extends Fragment {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.mContentView.setText(mValues.get(position).screenName);
            ...
            holder.itemView.setOnLongClickListener(v -> {
                ...
                ClipData dragData = new ClipData(
                        ((PlaceholderContent.PlaceholderItem) v.getTag()).screenName,
